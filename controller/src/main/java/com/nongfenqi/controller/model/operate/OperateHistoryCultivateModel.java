 ...
 * @since [农人帮/V1.4.0]
 */
public class OperateHistoryCultivateModel {
    private static final String TAG = OperateHistoryCultivateModel.class.getSimpleName();
    ...
    @Override
    public String toString() {
        return "OperateHistoryCultivateModel{" +
                "beginDate='" + beginDate + '\'' +
                ", cost=" + cost +
                ", endDate='" + endDate + '\'' +
                ", id=" + id +
